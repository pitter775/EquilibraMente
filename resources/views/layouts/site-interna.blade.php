...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="@vasset('app-assets/vendors/css/extensions/toastr.min.css')">
      <link rel="stylesheet" type="text/css" href="@vasset('app-assets/css/plugins/extensions/ext-component-toastr.css')">
    <link rel="stylesheet" type="text/css" href="@vasset('app-assets/css/plugins/extensions/ext-component-sweet-alerts.css')">
  ...
  <!-- Vendor CSS Files -->
  <link href="@vasset('assets/vendor/bootstrap/css/bootstrap.min.css')" rel="stylesheet">
  <link href="@vasset('assets/vendor/icofont/icofont.min.css')" rel="stylesheet">
  <link href="@vasset('assets/vendor/boxicons/css/boxicons.min.css')" rel="stylesheet">
  <link href="@vasset('assets/vendor/venobox/venobox.css')" rel="stylesheet">
  <link href="@vasset('assets/vendor/owl.carousel/assets/owl.carousel.min.css')" rel="stylesheet">
  <link href="@vasset('assets/vendor/aos/aos.css')" rel="stylesheet">

  

  <link rel="stylesheet" href="@vasset('app-assets/vendors/css/calendars/fullcalendar.min.css')">
  <link rel="stylesheet" href="@vasset('app-assets/vendors/css/pickers/flatpickr/flatpickr.min.css')">
  <link rel="stylesheet" href="@vasset('app-assets/vendors/css/forms/select/select2.min.css')">


  <link href="@vasset('assets/css/style.css')" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="fixed-top header-transparent">
    <div class="container d-flex align-items-center hero-content">
      ...
      <div class="logo mr-auto">
        <a href="/"><img src="/assets/img/logotextopp.png" style="padding: 13px 13px 13px 0 ; width: 250px"> </a>
      </div>
  ...
  <!-- Vendor JS Files -->
  <script src="@vasset('assets/vendor/jquery/jquery.min.js')"></script>
  <script src="@vasset('assets/vendor/bootstrap/js/bootstrap.bundle.min.js')"></script>
  <script src="@vasset('assets/vendor/jquery.easing/jquery.easing.min.js')"></script>
  <script src="@vasset('assets/vendor/php-email-form/validate.js')"></script>
  <script src="@vasset('assets/vendor/waypoints/jquery.waypoints.min.js')"></script>
  <script src="@vasset('assets/vendor/counterup/counterup.min.js')"></script>
  <script src="@vasset('assets/vendor/isotope-layout/isotope.pkgd.min.js')"></script>
  <script src="@vasset('assets/vendor/venobox/venobox.min.js')"></script>
  <script src="@vasset('assets/vendor/owl.carousel/owl.carousel.min.js')"></script>
  <script src="@vasset('assets/vendor/aos/aos.js')"></script>
  <!-- FullCalendar e Dependências -->
  <script src="@vasset('app-assets/vendors/js/calendar/fullcalendar.min.js')"></script>
  <script src="@vasset('app-assets/vendors/js/extensions/moment.min.js')"></script>
  <script src="@vasset('app-assets/vendors/js/forms/select/select2.full.min.js')"></script>
  <script src="@vasset('app-assets/vendors/js/pickers/flatpickr/flatpickr.min.js')"></script>
  ...
  <!-- Template Main JS File -->
    ...
    <script>
      ...
      $(document).ready(function() {
        const datatablesLangUrl = "@vasset('assets/js/datatables-pt-br.json')";
